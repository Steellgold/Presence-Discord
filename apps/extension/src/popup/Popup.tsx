...
export const Popup = (): JSX.Element => (
  <main className="grid w-80 gap-4 bg-[linear-gradient(135deg,rgba(88,101,242,0.22),transparent_48%),#11131a] p-[18px] text-[#edf2ff]">
    <header className="flex items-center gap-2.5">
      <span
        className="size-2.5 rounded-full bg-[#23a55a] shadow-[0_0_0_4px_rgba(35,165,90,0.16)]"
        aria-hidden="true"
      />
    ...
    <dl className="m-0 grid gap-2.5">
      <div className="flex min-h-[42px] items-center justify-between rounded-lg border border-[#edf2ff1f] bg-white/5 px-3 py-2.5">
        <dt className="m-0 text-[13px] tracking-normal text-[#aab3c8]">
